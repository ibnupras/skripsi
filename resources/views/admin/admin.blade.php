...
@section('content')
    ...
    <div class="maptools-wrapper">
        <div class="maptools-group">
            <button class="btn btn-primary rounded-0 px-3" id="info" data-title="Informasi Details" data-function-active=false type="button"><i class="fa fa-thumb-tack"></i></button>
            <button class="btn btn-primary rounded-0 px-3 back-to-extent" data-title="Back to Extent" type="button"><i class="fa fa-arrows-alt" aria-hidden="true"></i></button>
            <button class="btn btn-primary rounded-0 px-3" id="geolocation" data-title="Geolocation" type="button"><i class="fa fa-location-arrow" aria-hidden="true"></i></button>
        </div>
        <div class="maptools-group">
    ...
    <div>
        <div class="sidebar p-4 bg-primary" id="sidebar">
            ...
            <li>
              <button class="kantor btn btn-light text-dark fw-bold">Kantor</button>
            </li>
            <li>
          ...
          <button class="btn btn-primary" id="button-toggle">
            ...
            <div class="baselayer-switcher">
                ...
                <div class="more-layers-wrapper">
                    <div class="box"> <div class="flex"> </div> </div>
                </div>
            </div>
